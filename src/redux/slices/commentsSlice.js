...
export const commentsSlice = createSlice({
  ...
  initialState: {
    ...
    commentSimulationCounterForId: 0,
  },
  reducers: {
    ...
    setCommentSimulationCounterForId: (state, action) => {
      state.commentSimulationCounterForId =
        state.commentSimulationCounterForId + action.payload.value;
    },
  },
});
...
export const {
  ...
  setCommentSimulationCounterForId,
